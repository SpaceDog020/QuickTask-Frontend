...
const EditProject: React.FC<Props> = ({ navigation: { navigate } }) => {
  ...
  const { projectName: oldProjectName, setProjectName: setOldProjectName } = useUserStore();
  const [newProjectName, setNewProjectName] = useState(oldProjectName);
  const { projectDescription: oldProjectDescription, setProjectDescription: setOldProjectDescription } = useUserStore();
  const [newProjectDescription, setNewProjectDescription] = useState(oldProjectDescription);
  ...
  const handleButtonPress = () => {
    if (editable) {
      ...
      if (newProjectName !== oldProjectName || newProjectDescription !== oldProjectDescription) {
      ...
      <SafeAreaView>
        ...
        >
          ...
          <View>
            ...
            <AppTextInput placeholder="Nombre" value={newProjectName} editable={editable} onChangeText={setNewProjectName} />
            <Text
              style={{
                fontFamily: Font["poppins-semiBold"],
                fontSize: FontSize.medium,
